...
const poetries = ref([
    ...
    },*/
  {
    ...
    title: '论诗',
    isPoem: true,
    children: ['唐朝李杜诗篇传，至今音韵余有味。', '新社翻梗旧时去，现代诗词须创鲜。'],
  },
  {
    id: 16,
    title: '鬼之灵',
  ...
  },
  {
    ...
    title: '七言绝句',
    isPoem: true,
    children: ['深夜深思深世道，浅水潜藏潜智慧。', '人无学识遭人逼，虎落平阳被犬欺。'],
  },
  {
    id: 18,
    title: '诗风',
    isPoem: true,
    children: ['灵渠思兴词安聚，点笔惊鸿一触飞。', '命蹼生劳功消散，诗人风度今何在？'],
  },
  {
    id: 19,
    title: '望月赋',
    isPoem: true,
    children: ['望明思秋月，怀乡上心头。', '静坐玉溪上，独享清赋中。'],
  },
  {
    id: 20,
    title: '诉衷情',
  ...
  },
  {
    ...
    title: '无题',
    isPoem: true,
    children: ['满头悝絮道不尽，多恨学业晚难成。', '一心振华思康衢，无才借言祸百姓。'],
  },
  {
    id: 24,
    title: '人生易老·功千古',
    ...
    },*/
  {
    ...
    title: '虞美人·销魂',
    isPoem: true,
    children: ['青柳临池，月光同赏，卿余溪边随风愉。', '红花满岸，阳晕即晨，离别黯香伴君去。'],
  },
  {
    id: 31,
    title: '正气书香',
    isPoem: true,
    children: ['家国万气书香正，山河点饰将势风。', '不畏峥嵘埋伏笔，有幸迤逦现忠魂。'],
  },
  /*{
        id: 32,
        title: '长恨空',
...
<template>
  <div
    ...
    <div class="poetry-content">
      <p
        v-for="photograph in item.children"
        :class="item.isPoem ? 'text-center' : ''">
        {{ photograph }}
      </p>
    </div>
  </div>
