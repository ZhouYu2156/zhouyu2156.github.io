  ...
  <section
    ...
    <div class="utility-tools__grid">
      <article
        ...
        class="utility-tools__card group">
        <a
          class="utility-tools__primary"
          :href="item.link.href"
          :target="item.link.target"
          :rel="linkRel(item)">
          <div class="utility-tools__media">
            <img
              class="utility-tools__img"
              :src="item.img.src"
              :alt="item.img.alt"
              loading="lazy"
              decoding="async" />
          ...
          <div class="utility-tools__body">
            <div class="utility-tools__headline">
              ...
              <span
                v-if="item.link.target === '_blank'"
                class="utility-tools__external"
                aria-hidden="true">
                <svg
                  class="utility-tools__external-icon"
                  viewBox="0 0 12 12"
                  fill="none"
        ...
        <a
          v-if="item.github"
          class="utility-tools__github"
          :href="item.github.link"
          target="_blank"
          rel="noopener noreferrer"
          :aria-label="`${item.link.title} 的 GitHub 仓库`">
          <img
            class="utility-tools__github-img"
            :src="item.github.icon"
            alt=""
            width="18"
            height="18"
            loading="lazy"
...
.utility-tools__card {
  ...
  @apply hover:shadow-[0_12px_40px_-16px_rgba(100,108,255,0.35)];
}
